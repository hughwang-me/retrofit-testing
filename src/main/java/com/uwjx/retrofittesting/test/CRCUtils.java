...
public class CRCUtils {
    ...
    public static String getCrc(byte[] data) {
    	int res = calcCrc16(data);
        String format = String.format("%04x", res);
        String s1 = format.substring(0,2);
        String s2 = format.substring(2,4);
        return  (s2 + s1).toUpperCase();
    }

    public static byte[] getCrcByte(byte[] data) {
        return  ByteUtils.hexStringToBytes(getCrc(data));
    }
}
